window.onload = function() {
    ...
    //Globals
    var updateCount = 0;
    // Chart Objects : On déclare les objets
    ...
    //Les graphiques ont des options en commun qu'un note ici
    var commonOptions = {
        scales: {
          xAxes: [{
            type: 'time',
    ...
    var xAccelChartInstance = new Chart(xAccelChart, {
        ...
        //Object.assign() va assigner commonOptions à option pour pas qu'on ait à 
